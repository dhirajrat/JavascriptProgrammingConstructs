...
n 
const display= prompt('Enter 1. Feet to Inch '+'2. Feet to Meter '+'3. Inch to Feet '+'4. Meter to Feet option: ');                           
 
                             
const num = prompt("Enter the choice for the unit conversion: ");  
